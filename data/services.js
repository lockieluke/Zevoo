...
const servicesURLs = {discord: 'https://discord.com/app', whatsaspp: 'https://web.whatsapp.com', signal: 'about:blank', tg: 'https://web.telegram.org'}
let serviceCounter = 0

module.exports = {services, serviceIcons, servicesURLs, serviceCounter}